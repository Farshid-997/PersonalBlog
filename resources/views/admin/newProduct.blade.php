              ...
              @endif
                 ...
                 <form action="{{route('adminNewProduct')}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="file" name="thumbnail" id="normal-input" class="form-control" value="Post Title">
                            </div>
                        </div>
                        </div>
                      ...
                      <div class="row">
                          <div class="col-md-8">
                              <div class="form-group">
                                  ...
                                  <input name="title" id="normal-input" class="form-control" value="Product Title">
                              </div>
                          </div>
                          </div>
                    ...
                    <button class="btn btn-success" type="submit">Created Product</button>
                  </div>
                </form>
              </div>
          </div>
